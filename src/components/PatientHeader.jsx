      ...
      <AppBar position="static" style={{boxShadow:"none", backgroundColor:"black"}}>
        <Toolbar>
          <Typography
            ...
            style ={{cursor:"pointer", backgroundColor:location.pathname=="/PatientHome"?"white":"", color:location.pathname=="/PatientHome"?"black":"", textAlign:"center", borderRadius: location.pathname=="/Home"?5:5}}
            onClick={()=>{ history("/PatientHome");}}
          >
            Home
          </Typography>
          {/* <Typography
